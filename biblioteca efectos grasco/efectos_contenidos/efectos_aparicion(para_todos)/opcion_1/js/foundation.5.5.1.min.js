    ...
    Foundation.libs.dropdown = {
        ...
        events: function() {
            ...
            n(this.scope).off(".dropdown").on("click.fndtn.dropdown", "[" + this.attr_name() + "]", function(e) {
                ...
                (!i.is_hover || Modernizr.touch) && (e.preventDefault(), n(this).parent("[data-reveal-id]") && e.stopPropagation(), s.toggle(t(this)))
...
function(t, e, i, s) {
    ...
    Foundation.libs.clearing = {
        ...
        open: function(e, s, n) {
            ...
            function o(e) {
                var i = t(e);
                i.css("visibility", "visible"), l.css("overflow", "hidden"), d.addClass("clearing-blackout"), c.addClass("clearing-container"), h.show(), this.fix_height(n).caption(r.S(".clearing-caption", h), r.S("img", n)).center_and_label(e, f).shift(s, n, function() {
    ...
    Foundation.libs.reveal = {
        ...
        open: function(i, s) {
            ...
            if (!n.hasClass("open")) {
                ...
                if ("undefined" == typeof n.data("css-top") && n.data("css-top", parseInt(n.css("top"), 10)).data("offset", this.cache_offset(n)), this.key_up_on(n), n.on("open.fndtn.reveal").trigger("open.fndtn.reveal"), r.length < 1 && this.toggle_bg(n, !0), "string" == typeof s && (s = {
                        url: s
                    ...
                    t.extend(s, {
                        success: function(e, i, s) {
                            ...
                            n.html(e), a.S(n).foundation("section", "reflow"), a.S(n).children().foundation(), r.length > 0 && (o.multiple_opened ? this.to_back(r) : this.hide(r, o.css.close)), a.show(n, o.css.open)
                        }
                    }), t.ajax(s)
                } else r.length > 0 && (o.multiple_opened ? this.to_back(r) : this.hide(r, o.css.close)), this.show(n, o.css.open)
            }
        ...
        close: function(e) {
            var e = e && e.length ? e : this.S(this.scope),
                ...
                s = e.data(this.attr_name(!0) + "-init") || this.settings;
            i.length > 0 && (this.locked = !0, this.key_up_off(e), e.trigger("close").trigger("close.fndtn.reveal"), (s.multiple_opened && 1 === i.length || !s.multiple_opened || e.length > 1) && (this.toggle_bg(e, !1), this.to_front(e)), s.multiple_opened ? (this.hide(e, s.css.close, s), this.to_front(t(t.makeArray(i).reverse()[1]))) : this.hide(i, s.css.close, s))
        },
    ...
    Foundation.libs["magellan-expedition"] = {
        ...
        events: function() {
            ...
            i.set_expedition_position(), s(i.scope).off(".magellan").on("click.fndtn.magellan", "[" + i.add_namespace("data-magellan-arrival") + '] a[href^="#"]', function(e) {
                ...
                n.offset_by_height && (r -= s.outerHeight()), t("html, body").stop().animate({
                    scrollTop: r
...
function(t, e, i) {
    ...
    Foundation.libs.topbar = {
        ...
        is_sticky: function(t, e, i) {
            ...
            return s && "all" === i.sticky_on ? !0 : s && this.small() && -1 !== i.sticky_on.indexOf("small") && n && !a && !o ? !0 : s && this.medium() && -1 !== i.sticky_on.indexOf("medium") && n && a && !o ? !0 : s && this.large() && -1 !== i.sticky_on.indexOf("large") && n && a && o ? !0 : s && navigator.userAgent.match(/(iPad|iPhone|iPod)/g) ? !0 : !1
        },
        toggle: function(i) {
            var s, n = this;
...
function(t, e, i, s) {
    ...
    Foundation.libs.tab = {
        ...
        init: function(t, i, s) {
            var n = this,
                a = this.S;
            this.bindings(i, s), n.entry_location = e.location.href, this.handle_location_hash_change(), a("[" + this.attr_name() + "] > .active > a", this.scope).each(function() {
        ...
        toggle_active_tab: function(n, a) {
            ...
            r(this).data(this.data_attr("tab-content")) && (h = "#" + r(this).data(this.data_attr("tab-content")).split("#")[1], u = r(h)), p.deep_linking && (p.scroll_to_content ? (_(a || h), a == s || a == h ? n.parent()[0].scrollIntoView() : r(h)[0].scrollIntoView()) : _(a != s ? "fndtn-" + a.replace("#", "") : "fndtn-" + h.replace("#", ""))), n.addClass(p.active_class).triggerHandler("opened"), d.attr({
                "aria-selected": "true",
                tabindex: 0
                ...
                "aria-hidden": "true",
                tabindex: -1
            }), u.addClass(p.active_class).attr("aria-hidden", "false").removeAttr("tabindex"), p.callback(n), u.triggerHandler("toggled", [n]), l.triggerHandler("toggled", [u]), d.off("keydown").on("keydown", g)
        },
        data_attr: function(t) {
            return this.namespace.length > 0 ? this.namespace + "-" + t : t
        },
    ...
    Foundation.libs.abide = {
        ...
        events: function(e) {
            ...
            this.invalid_attr = this.add_namespace("data-invalid"), s.off(".abide").on("submit.fndtn.abide validate.fndtn.abide", function(t) {
                ...
                n.live_validate === !0 && 9 != t.which && (clearTimeout(i.timer), i.timer = setTimeout(function() {
                    i.validate([this], t)
                }.bind(this), n.timeout))
            })
        },
        ...
        valid_radio: function(t) {
            for (var e = t.getAttribute("name"), i = this.S(t).closest("[data-" + this.attr_name(!0) + "]").find("[name='" + e + "']"), s = i.length, n = !1, a = !1, o = 0; s > o; o++) i[o].getAttribute("disabled") ? (a = !0, n = !0) : i[o].checked ? n = !0 : a && (n = !1);
